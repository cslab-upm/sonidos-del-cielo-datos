...
def test_sdc_hourly():
    ...
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '01/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '02/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '03/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '04/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '05/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '06/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '07/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '08/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '09/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '10/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '11/2020')
    ml.plt.clf()
    ml.create_hourly_month(sdc_hourly_month, '12/2020')
    ml.plt.clf()
